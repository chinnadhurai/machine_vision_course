...
class conv_net:
    def __init__(self, config):
        ...
        self.w5  = l.init_weights((1024,256,4,4))     #full-conn
    ...
    def model(self, X, w1, w2, w3, w4, w5, w6,w_o, p_drop_conv, p_drop_hidden):
        l1a = l.rectify(conv2d(X, w1, border_mode=1))
        l1 = max_pool_2d(l1a, (2, 2))
        #l1 = l.dropout(l1, p_drop_conv)

        l2a = l.rectify(conv2d(l1, w2,border_mode=1))
        l2 = max_pool_2d(l2a, (2, 2))
        #l2 = l.dropout(l2, p_drop_conv)

        l3 = l.rectify(conv2d(l2, w3, border_mode=1))
        #l3 = l.dropout(l3a, p_drop_conv)

        l4a = l.rectify(conv2d(l3, w4, border_mode=1))
        l4 = max_pool_2d(l4a, (2, 2))
        #l4 = T.flatten(l4, outdim=2)
        #l4 = l.dropout(l4, p_drop_conv)

        l5 = l.rectify(conv2d(l4, w5, border_mode=1))
        #l5 = l.dropout(l5, p_drop_hidden)

        l6 = l.rectify(conv2d(l5, w6, border_mode=1))
        #l6 = l.dropout(l6, p_drop_hidden)
        #l6 = self.bn(l6, self.g,self.b,self.m,self.v)

        pyx = l.softmax(conv2d(l6, w_o, border_mode=1))
    ...
    def build_model(self):
        ...
        l1, l2, l3, l4, py_x = self.model(X, w, w2, w3, w4, w5, w6, w_o, 0., 0.)
